...
const basicUserScheme = {
    ...
    username: yup.string().min(3, "Please enter a username longer than 3").matches(hasLettersRegex, 'Input is empty!').matches(invisibleCharcters, 'Illegal charcters!'),
    password: yup.string().matches(hasLettersRegex, 'Input is empty!').matches(invisibleCharcters, 'Illegal charcters!'),
}
